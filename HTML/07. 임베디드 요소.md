...
| --------- | <------------------------------------------------------- |
| src       | 이미지 파일 경로                                        |
| alt       | alternative text. 이미지 파일이 없을 경우 표시되는 문장 |
...
현재 문서 안에 다른 HTML 페이지를 삽입합니다. 보통 구글 웹 같은 것 삽입할 때 많이 사용합니다. 인라인 프레임으로 허용된 url만 사용 가능합니다. ( 그래서 네이버 지도는 안될 수도 있습니다....)
