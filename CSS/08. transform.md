...
## 2. 크기 - scale
`scale()`는 크기 조절. 2d만 사용가능. 3d는 불가능. 자료형은 number 값 사용 가능.
...
transform: scale(0.5); 를 지정해 0.5만큼 축소됨.콘텐츠 크기는 width: 200px이고 이 상태에서 한번 더 scale을 지정해서 width: 100px임을 볼 수 있다.
...
## 3. rotate
회전하는 함수. 하나의 값만 받을 수 있습니다.

**자료형**

![angle 예제](./images/angle.png)
