...
|값|설명|미리보기|
|---|---|---|
|stretch|기본값. |<img src="./images/align-content-stretch.png" width="135px" height="150px">|
|flex-start|cross start(교차축의 시작점)을 기준으로 정렬|<img src="./images/align-content-flex-start.png" width="135px" height="150px">|
|flex-end|cross end(교차축의 끝점)을 기준으로 정렬|<img src="./images/align-content-flex-end.png" width="135px" height="150px">|
|center|Flex Container 중앙에 정렬|<img src="./images/align-content-center.png" width="135px" height="150px">|
|space-between|첫번째 Flex Item의 행은 Flex Container의 상단에 마지막 Flex Item의 행은 Flex Container의 하단에  정렬되고 나머지 Item들의 행 사이(between)에 균등한 간격으로 정렬 |<img src="./images/align-content-space-between.png" width="135px" height="150px">|
|space-around|모든 Flex Item은 균등한 간격으로 정렬 |<img src="./images/align-content-space-around.png" width="135px" height="150px">|
